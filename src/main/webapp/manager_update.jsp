...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="content">
			<br><h2>Update Product</h2><br>
			<form name="product_form" action="ControllerServlet?command=manager_update2&product_number=${product.getProductNumber() }" 
			...
			<table border=0 width="680px">	
				...
				<tr>
					...
					<td>
						<input type="text" name="product_price" maxlength="10" value="${product.getProductPrice() }">
					</td>
				</tr>
				<tr>
					<th class="pr">상품 소개</th>
					<td>
						<textarea name="product_content" row="12" cols="50">${product.getProductContent() }</textarea>
					</td>
				</tr>
				<tr>
